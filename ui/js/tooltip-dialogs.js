...
var TooltipDialogs = (function() {
  ...
  var dialogBoxes = [
    ...
    },
    {
      ...
      text:
        'And if you don’t know what to ask, click here to see what I am trained to understand.',
      showId: 'help',
    },
  ];
  ...
  function nextDialog() {
    var oldShow = document.getElementById(
      dialogBoxes[dialogIndex.get()].showId,
    );
    if (oldShow) {
    ...
    if (dialogIndex.get() >= dialogBoxes.length) {
      ...
      var newShow = document.getElementById(
        dialogBoxes[dialogIndex.get()].showId,
      );
      if (newShow) {
